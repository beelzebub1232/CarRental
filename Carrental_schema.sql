...
INSERT IGNORE INTO vehicles (make, model, year, type, base_price, availability, pickup_location_lat, pickup_location_lng, image_url) VALUES
...
INSERT IGNORE INTO pricing_rules (rule_type, vehicle_type, location_id, peak_start_time, peak_end_time, ramp_up_minutes, cool_down_minutes, modifier_percentage, description) VALUES
('time_peak', NULL, NULL, '17:00:00', '19:00:00', 30, 30, 25.00, 'Evening peak hours'),
('demand_car_type', 'Luxury SUV', NULL, NULL, NULL, 0, 0, 15.00, 'High demand for luxury SUVs'),
('demand_car_type', 'Electric', NULL, NULL, NULL, 0, 0, 10.00, 'Eco-friendly premium');

-- Insert sample discounts
INSERT IGNORE INTO discounts (code, discount_percentage, start_date, end_date, vehicle_id, vehicle_type, usage_limit, times_used, is_active, description) VALUES
('WELCOME20', 20.00, '2024-01-01', '2024-12-31', NULL, NULL, 100, 0, TRUE, 'Welcome discount for new customers'),
('LUXURY50', 50.00, '2024-01-01', '2024-12-31', NULL, 'Luxury SUV', 20, 0, TRUE, 'Special discount on luxury SUVs'),
('ELECTRIC15', 15.00, '2024-01-01', '2024-12-31', NULL, 'Electric', 50, 0, TRUE, 'Eco-friendly vehicle discount'); 